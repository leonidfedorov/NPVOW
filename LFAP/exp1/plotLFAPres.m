function [standarderror] = plotLFAPresNEW(dname)
...
colorlist = [166,206,227;...
    ...
    177,89,40,
    153,255,255]/256;
shiftlist = [0:0.1964/13:0.1963]/3;
...
for n = 1:numfiles,
    ...
    set(gca,'XTickLabel',{'0','22.5','45','77.25','90','112.5','135','157.5','180'}); 
    %TODO: fix axes labeling problem- atm not corresponding to real values
...
figure;
errorbar(towa(:,1),towaPulledMean,towaPulledStd/sqrt(13));%,{'LineStyle','-','LineWidth',4.0,'Color',[0 0 0]},1)
